...
<div class="w-100 border__menu bacground_menu_home">
    <div class="d-sm-flex justify-content-start align-items-center">
        <a class=" nav-link pt-4 pb-4 mr-5 color_link" href="{{route('admin.index')}}">
            <div class="sb-nav-link-icon"><i class="fas fa-user"></i></div>
            Użytkownicy
        </a>
        <a class=" nav-link pt-4 pb-4 color_link" href="{{route('admin.task.index')}}">
...
<div class="w-100 bacground_menu_home">
    <div class="d-sm-flex justify-content-start align-items-center">
        <a class="nav-link pt-4 pb-4 mr-5 color_link" href="{{route('admin.addUser')}}">
            <div class="sb-nav-link-icon"><i class="fas fa-tasks"></i></div>
            Dodaj użytkownika
        </a>

        <a class="nav-link pt-4 pb-4 mr-5 color_link" href="{{route('admin.task.create')}}">
            <div class="sb-nav-link-icon"><i class="fas fa-tasks"></i></div>
            Dodaj zadanie
        </a>
