...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('super.task.store')}}" method="post">
                @csrf
                <div class="mb-3">
                    <label for="selectUser" class="form-label">Wybierz pracownika:</label>
                    <select class="form-control  @error('selectUser') is-invalid @enderror" aria-label="lista pracowników" id="selectUser"  name="selectUser">
